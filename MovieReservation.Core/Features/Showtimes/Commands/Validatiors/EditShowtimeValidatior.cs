...
{
    public class EditShowtimeValidatior : AbstractValidator<EditShowtimeCommand>
    {
        #region Fields
        ...
        #region Constructors
        public EditShowtimeValidatior(IMovieService movieService, ITheaterService theaterService)
        {
